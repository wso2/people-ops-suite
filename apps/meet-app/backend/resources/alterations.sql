...
ALTER TABLE `meeting` 
  ADD COLUMN `host_team` VARCHAR(50) NULL DEFAULT 'N/A' AFTER `host`,
  ADD COLUMN `host_sub_team` VARCHAR(50) NULL DEFAULT 'N/A' AFTER `host_team`,
  ADD COLUMN `host_bu` VARCHAR(50) NULL DEFAULT 'N/A' AFTER `host_sub_team`,
  ADD COLUMN `host_unit` VARCHAR(50) NULL DEFAULT 'N/A' AFTER `host_bu`;